...
namespace MOE.Common.Business.WCFServiceLibrary
{
    ...
    public class PreemptServiceRequestOptions: MetricOptions
    {
        ...
        public override List<string> CreateMetric()
        {
            ...
            MOE.Common.Business.Preempt.PreemptRequestChart prChart = new MOE.Common.Business.Preempt.PreemptRequestChart(StartDate, EndDate, SignalID, location, eventsTable);
