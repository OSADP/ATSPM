...
namespace MOE.Common.Business.WCFServiceLibrary
{
    ...
    public class ApproachSpeedOptions: MetricOptions
    {
        ...
        private Chart GetNewSpeedChart(string location, Models.Detector detector)
        {
            ...
            //Set the chart title
            chart.Titles.Add(location + "Signal " + SignalID + " " + "Phase " + detector.Approach.ProtectedPhaseNumber.ToString() + " " + detector.Approach.DirectionType.Description
                + "\n" + StartDate.ToString("f") + " - " + EndDate.ToString("f")
                + "\n" + "Detector Distance from Stop Bar: " + detector.DistanceFromStopBar.ToString() + " feet; " + "Min Speed Filter: " + detector.MinSpeedFilter.ToString() + " MPH; "
                + "\n" + "Time Filter: " + detector.MovementDelay.ToString() + "s after start of green to start of yellow"
