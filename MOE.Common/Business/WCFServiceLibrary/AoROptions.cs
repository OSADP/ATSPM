        ...
        public override List<string> CreateMetric()
        {
           ...
           false, SelectedBinSize, 9);
            ...
            if (signalphasecollection.SignalPhaseList.Count > 0)
            {
                ...
                {
                    MOE.Common.Business.ArriveOnRedChart AoRChart = new MOE.Common.Business.ArriveOnRedChart(StartDate,
                        EndDate, signalPhase, SelectedBinSize, location,
                       YAxisMax, true, ShowPlanStatistics);
