        ...
        public override List<string> CreateMetric()
        {
            ...
            if (signalphasecollection.SignalPhaseList.Count > 0)
            {
                foreach (MOE.Common.Business.RLMSignalPhase signalPhase in signalphasecollection.SignalPhaseList)
                {
                    ...
                    Chart chart = MOE.Common.Business.RLMChart.GetChart(signalPhase.Approach.IsProtectedPhaseOverlap,
                        signalPhase.Approach.DirectionType.Description, location, SignalID, 
                        signalPhase.Approach.ProtectedPhaseNumber, StartDate,
                        EndDate, signalPhase,
                        YAxisMax.Value,
                        ShowRedLightViolations,
                        ShowSevereRedLightViolations,
                        ShowPercentRedLightViolations,
                        ShowPercentSevereRedLightViolations,
                        ShowAverageTimeRedLightViolations,
                        ShowYellowLightOccurrences,
                        ShowPercentYellowLightOccurrences,
                        ShowAverageTimeYellowOccurences);
