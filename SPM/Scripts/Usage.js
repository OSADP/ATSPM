...
function GetActionsByMetricID(tosend, metricTypeID, metricAbbreviation) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#PlaceHolder_" + metricAbbreviation).html(data);
        },
        statusCode: {
...
function GetReportRuns(tosend)
{
    $.ajax({
        ...
        url: urlReportsRun,
        success: function (data) {
            $("#ReportsRunPlaceHolder").html(data);
        },
        statusCode: {
            404: function (content) { alert('cannot find resource'); },
            500: function (content) { alert('internal server error'); }
...
function GetActionsByMetric(tosend) {
    $.ajax({
        ...
        success: function (data) {
            $("#ActionsByMetricPlaceHolder").html(data);
        },
        statusCode: {
            404: function (content) { alert('cannot find resource'); },
            500: function (content) { alert('internal server error'); }
...
function GetMetricsUsage(tosend) {
    $.ajax({
        ...
        url: urlMetricsUsage,
        success: function (data) {
            $("#MetricsUsagePlaceHolder").html(data);
        },
        statusCode: {
            404: function (content) { alert('cannot find resource'); },
            500: function (content) { alert('internal server error'); }
...
function GetAgencyUsage(tosend) {
    $.ajax({
        ...
        url: urlAgencyUsage,
        success: function (data) {
            $("#AgencyUsagePlaceHolder").html(data);
        },
        statusCode: {
            404: function (content) { alert('cannot find resource'); },
            500: function (content) { alert('internal server error'); }
