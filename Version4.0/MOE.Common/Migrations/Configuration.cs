...
While each agency should consult with their IT department for specific guidelines on how to best deliver a secure, stable and responsive solution, we can estimate that most mid-range to high-end servers will be able to handle the task of hosting and creating metrics for most agencies."
            ...
            context.Menus.AddOrUpdate(
              ...
              new Models.Menu { MenuId = 4, MenuName = "Links", Controller = "#", Action = "#", ParentId = 0, Application = "SignalPerformanceMetrics", DisplayOrder = 4 },
               ...
               new Models.Menu { MenuId = 34, MenuName = "GDOT ATSPM documentation", Controller = "Images", Action = "Documentation.pdf", ParentId = 30, Application = "SignalPerformanceMetrics", DisplayOrder = 1 },
              ...
              new Models.Menu { MenuId = 15, MenuName = "Roles", Controller = "Account", Action = "RoleIndex", ParentId = 14, Application = "SignalPerformanceMetrics", DisplayOrder = 1 },
            ...
            context.MetricTypes.AddOrUpdate(
                c => c.ChartName,
                new Models.MetricType { MetricID = 1, ChartName = "Purdue Phase Termination", Abbreviation = "PPT" ,ShowOnWebsite = true, DetectionTypeID = detectionTypes[1].DetectionTypeID },
                new Models.MetricType { MetricID = 2, ChartName = "Split Monitor", Abbreviation = "SM", ShowOnWebsite = true, DetectionTypeID = detectionTypes[1].DetectionTypeID },
                new Models.MetricType { MetricID = 3, ChartName = "Pedestrian Delay", Abbreviation = "PedD", ShowOnWebsite = true, DetectionTypeID = detectionTypes[1].DetectionTypeID },
                new Models.MetricType { MetricID = 4, ChartName = "Preemption Details", Abbreviation = "PD", ShowOnWebsite = true, DetectionTypeID = detectionTypes[1].DetectionTypeID },
                new Models.MetricType { MetricID = 5, ChartName = "Turning Movement Counts", Abbreviation = "TMC", ShowOnWebsite = true, DetectionTypeID = detectionTypes[4].DetectionTypeID },
                new Models.MetricType { MetricID = 6, ChartName = "Purdue Coordination Diagram", Abbreviation = "PCD", ShowOnWebsite = true, DetectionTypeID = detectionTypes[2].DetectionTypeID },
                new Models.MetricType { MetricID = 7, ChartName = "Approach Volume", Abbreviation = "AV", ShowOnWebsite = true, DetectionTypeID = detectionTypes[2].DetectionTypeID },
                new Models.MetricType { MetricID = 8, ChartName = "Approach Delay", Abbreviation = "AD", ShowOnWebsite = true, DetectionTypeID = detectionTypes[2].DetectionTypeID },
                new Models.MetricType { MetricID = 9, ChartName = "Arrivals On Red", Abbreviation = "AoR", ShowOnWebsite = true, DetectionTypeID = detectionTypes[2].DetectionTypeID },
                new Models.MetricType { MetricID = 10, ChartName = "Approach Speed", Abbreviation = "Speed", ShowOnWebsite = true, DetectionTypeID = detectionTypes[3].DetectionTypeID },
                new Models.MetricType { MetricID = 11, ChartName = "Yellow and Red Actuations", Abbreviation = "YRA", ShowOnWebsite = true, DetectionTypeID = detectionTypes[5].DetectionTypeID },
                new Models.MetricType { MetricID = 12, ChartName = "Purdue Split Failure", Abbreviation = "SF", ShowOnWebsite = true, DetectionTypeID = detectionTypes[6].DetectionTypeID },
                new Models.MetricType { MetricID = 13, ChartName = "Purdue Link Pivot", Abbreviation = "LP", ShowOnWebsite = false, DetectionTypeID = detectionTypes[2].DetectionTypeID },
                new Models.MetricType { MetricID = 14, ChartName = "Preempt Service Request", Abbreviation = "PSR", ShowOnWebsite = false, DetectionTypeID = detectionTypes[1].DetectionTypeID },
                new Models.MetricType { MetricID = 15, ChartName = "Preempt Service", Abbreviation = "PS", ShowOnWebsite = false, DetectionTypeID = detectionTypes[1].DetectionTypeID }
                );
            ...
            context.MovementTypes.AddOrUpdate(
                new Models.MovementType { MovementTypeID = 1, Description = "Thru", Abbreviation = "T" },
                new Models.MovementType { MovementTypeID = 2, Description = "Right", Abbreviation = "R" },
                new Models.MovementType { MovementTypeID = 3, Description = "Left", Abbreviation = "L" },
                new Models.MovementType { MovementTypeID = 4, Description = "Thru-Right", Abbreviation = "TR" },
                new Models.MovementType { MovementTypeID = 5, Description = "Thru-Left", Abbreviation = "TL" }

                );

            context.DirectionTypes.AddOrUpdate(
                new Models.DirectionType { DirectionTypeID = 1, Description =  "Northbound", Abbreviation = "NB"},
                new Models.DirectionType { DirectionTypeID = 2, Description =  "Southbound", Abbreviation = "SB"},
                new Models.DirectionType { DirectionTypeID = 3, Description =  "Eastbound", Abbreviation = "EB"},
                new Models.DirectionType { DirectionTypeID = 4, Description =  "Westbound", Abbreviation = "WB"},
                new Models.DirectionType { DirectionTypeID = 5, Description =  "NorthEast", Abbreviation = "NE"},
                new Models.DirectionType { DirectionTypeID = 6, Description =  "NorthWest", Abbreviation = "NW"},
                new Models.DirectionType { DirectionTypeID = 7, Description =  "SouthEast", Abbreviation = "SE"},
                new Models.DirectionType { DirectionTypeID = 8, Description =  "SouthWest", Abbreviation = "SW"}
            ...
            //These are default values.  They need to be changed before the system goes into produciton.
