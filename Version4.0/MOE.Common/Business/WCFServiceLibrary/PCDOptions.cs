...
namespace MOE.Common.Business.WCFServiceLibrary
{
    ...
    public class PCDOptions: MetricOptions
    {
        ...
        public override List<string> CreateMetric()
        {
            ...
            this.MetricTypeID = 6;
            //Signal.GetDataForPCD(StartDate, EndDate);
        ...
        {
            string title = CreateTitle(approach);
            Chart chart = MOE.Common.Business.ChartFactory.CreateDefaultChart(this, title);
        ...
        private string CreateTitle(Approach approach)
        {
            ...
            return(approach.Signal.GetSignalLocation() + " Signal " + SignalID + " "
                + movementType + ": " + approach.ProtectedPhaseNumber.ToString() +
        ...
        private void AddDataToChart(Chart chart, MOE.Common.Business.SignalPhase signalPhase)
        {
            ...
            {
                AddArrivalOnGreen(chart, totalOnGreenArrivals, totalDetectorHits);
            }
