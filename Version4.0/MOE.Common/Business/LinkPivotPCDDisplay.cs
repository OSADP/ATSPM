...
namespace MOE.Common.Business
{
    ...
    public class LinkPivotPCDDisplay
    {
            ...
            DateTime startDate, DateTime endDate, int maxYAxis)
        {
            ...
            //Generate the upstream charts
            GeneratePCD(upstreamSignal.Approaches.Where(a => a.DirectionType.Description == upstreamDirection).First(),
                delta, startDate, endDate, true, maxYAxis);
            //Generate the downstream charts
            GeneratePCD(downstreamSignal.Approaches.Where(a => a.DirectionType.Description == downstreamDirection).First(),
